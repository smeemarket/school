<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="phone_number_one" value="{{ __('Primary Phone') }}" />
                <x-jet-input id="phone_number_one" class="block mt-1 w-full" type="number" name="phone_number_one"
                    :value="old('phone_number_one')" required />
            </div>

            <div class="mt-4">
                <x-jet-label for="phone_number_two" value="{{ __('Secondary Phone') }}" />
                <x-jet-input id="phone_number_two" class="block mt-1 w-full" type="number" name="phone_number_two"
                    :value="old('phone_number_two')" />
            </div>

            <div class="mt-4">
                <x-jet-label for="region" value="{{ __('Region') }}" />
                <x-jet-input id="region" class="block mt-1 w-full" type="text" name="region" :value="old('region')"
                    required />
            </div>
